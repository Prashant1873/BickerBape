---
name: ux-laws
description: Essential UX design laws and principles (Hick's, Fitts's, Jakob's, Miller's, Peak-End, etc.) to optimize interface decision-making, hierarchy, error prevention, and user flows. Use when designing, building, or reviewing user interfaces.
---
